---
title: "F-13: 実験学習ループ"
source_path: "figures/f-13-experiment-learning-loop.md"
order: 520
...
- [第13章 失敗耐性と実験文化](../../chapters/chapter-13/): 小実験と学習を設計する。

### 本文での利用箇所

- [第13章 失敗耐性と実験文化](../../chapters/chapter-13/): 仮説、最小実験、実行、学習、判断を接続する。
