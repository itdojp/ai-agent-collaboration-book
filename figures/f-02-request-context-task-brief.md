...
- [第3章 依頼を契約にする](../manuscript/ch03-request-contract.md): Request Contractを定義する。
- [第4章 Context Packを設計する](../manuscript/ch04-context-design.md): 前提と制約を渡す。
- [第5章 タスク分解と委任](../manuscript/ch05-task-delegation.md): Task Briefへ落とす。

### 本文での利用箇所

- [第3章 依頼を契約にする](../manuscript/ch03-request-contract.md): 第3章〜第5章で、Request、Context、Delegationの接続を説明する。
