...
- [第12章 困難な会話と対立処理](../manuscript/ch12-conflict-connection-debt.md): Connection Debtの構造を確認する。

### 本文での利用箇所

- [第12章 困難な会話と対立処理](../manuscript/ch12-conflict-connection-debt.md): 言えていない懸念が組織負債へ変わる流れを説明する。
